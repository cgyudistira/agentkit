...
**Got questions?** You're not alone! Here are answers to the most common questions about Code Agents.
...
**No.** Skills are text files. However, they *instruct* the AI to run commands. If a skill says "delete all files", a compliant AI might try to do it.
*Always check the Risk label and review the code.*
