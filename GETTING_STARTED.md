# Getting Started with Code Agents (V3)
...
*Check the [Full Registry](README.md#full-skill-registry-255255) for risk labels.*
...
A: You clone the whole repo, but your AI only *reads* the ones you ask for (or that are relevant). It's lightweight!
