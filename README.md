# 🤖 Code Agents: 255+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More
...
[![Code Agents](https://img.shields.io/badge/Code%20Agents-cgyudistira-red)](https://github.com/cgyudistira/code-agents)

**Code Agents** is a curated, battle-tested library of **255 high-performance agentic skills** designed to work seamlessly across all major AI coding assistants:
...
> `git clone -c core.symlinks=true https://github.com/cgyudistira/code-agents.git`
...
git clone https://github.com/cgyudistira/code-agents.git .claude/skills

# Gemini CLI specific
git clone https://github.com/cgyudistira/code-agents.git .gemini/skills

# Cursor specific
git clone https://github.com/cgyudistira/code-agents.git .cursor/skills
```
...
* [cgyudistira](https://github.com/cgyudistira)
...
[![Star History Chart](https://api.star-history.com/svg?repos=cgyudistira/code-agents\&type=date\&legend=top-left)](https://www.star-history.com/#cgyudistira/code-agents\&type=date\&legend=top-left)
