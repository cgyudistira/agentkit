...
This guide details the exact procedures for maintaining `code-agents`.
...
* Running `update_readme.py` is NOT optional.
  *If CI fails because of drift, you have failed.*
...
2. **Regenerate Index**:
   python3 scripts/generate\_index.py
...
4. **COMMIT GENERATED FILES**:
   ...
   > See [docs/CI\_DRIFT\_FIX.md](../docs/CI_DRIFT_FIX.md) for details.
...
3. **Draft a Release**:
   * Go to [Releases Page](https://github.com/cgyudistira/code-agents/releases).
...
* **Code Agents Badge**: Must point to `https://github.com/cgyudistira/code-agents`, NOT `anthropics/antigravity`.
